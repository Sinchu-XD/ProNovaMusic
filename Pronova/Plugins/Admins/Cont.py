...
async def pause(client, m):
    try:
        ...
        LOGGER.error(f"[PAUSE CMD ERROR]\n{format_exc()}")
...
async def resume(client, m):
    try:
        ...
        LOGGER.error(f"[RESUME CMD ERROR]\n{format_exc()}")
...
async def previous(client, m):
    try:
        ...
        LOGGER.error(f"[PREVIOUS CMD ERROR]\n{format_exc()}")
...
async def forward(client, m):
    try:
        ...
        LOGGER.error(f"[FORWARD CMD ERROR]\n{format_exc()}")
...
async def rewind(client, m):
    try:
        ...
        LOGGER.error(f"[REWIND CMD ERROR]\n{format_exc()}")
...
async def queue(client, m):
    try:
        ...
        LOGGER.error(f"[QUEUE CMD ERROR]\n{format_exc()}")
