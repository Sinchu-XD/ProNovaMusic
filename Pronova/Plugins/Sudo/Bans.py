...
async def unban(client, m):
    try:
        ...
        LOGGER.error(f"[UNBAN CMD ERROR]\n{format_exc()}")
...
async def ungban(client, m):
    try:
        ...
        LOGGER.error(f"[UNGBAN CMD ERROR]\n{format_exc()}")
...
async def checkban(client, m):
    try:
        ...
        LOGGER.error(f"[CHECKBAN CMD ERROR]\n{format_exc()}")
...
async def total_banned_cmd(client, m):
    try:
        ...
        LOGGER.error(f"[TOTALBANNED CMD ERROR]\n{format_exc()}")
...
async def total_gbanned_cmd(client, m):
    try:
        ...
        LOGGER.error(f"[TOTALGBANNED CMD ERROR]\n{format_exc()}")
